...
# Saint-Laurent: XML is missing "Noël-Sud" and has two "Marcel-Laurin" and another "Beaudet".
# Saint-Léonard: XML is missing "Coubertin", "Guiseppe-Garibaldi" and "Saint-Léonard"
...
#    19 Ahuntsic-Cartierville                     17 (18)  17     0
#     7 Anjou                                      7        0     0
#       Baie-d'Urfé
...
#                                                         202    69
#
# puts Arrondissement.order(:nom_arr).map{|x|"#{x.patinoires.count.to_s.rjust(2)} #{x.nom_arr}"}
#
