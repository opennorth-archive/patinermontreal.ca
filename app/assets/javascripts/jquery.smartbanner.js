...
!function ($) {
    ...
    SmartBanner.prototype = {
      ...
      , create: function() {
            ...
            var banner = '<div id="smartbanner" class="'+this.type+'"><div class="sb-container"><a href="#" class="btn close pull-left sb-close">&times;</a><span class="sb-icon"></span><div class="sb-info"><strong>'+this.title+'</strong><span>'+this.author+'</span><span>'+inStore+'</span></div><a href="'+link+'" class="btn btn-xs btn-primary sb-button"><span>'+this.options.button+'</span></a></div></div>';
